 ...
 * Original file: /Users/micorochio/Documents/SVN/SVN/workspace/MobilePlatform/src/com/ustcinfo/mobile/download/services/IDownloadService.aidl
 */
package com.ustcinfo.mobile.download.services;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.ustcinfo.mobile.download.services.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.ustcinfo.mobile.download.services.IDownloadService";
...
/**
 * Cast an IBinder object into an com.ustcinfo.mobile.download.services.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.ustcinfo.mobile.download.services.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.ustcinfo.mobile.download.services.IDownloadService))) {
return ((com.ustcinfo.mobile.download.services.IDownloadService)iin);
}
return new com.ustcinfo.mobile.download.services.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.ustcinfo.mobile.download.services.IDownloadService
{
